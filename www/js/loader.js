...
(function () {
  ...
  is_element_in_viewport = function (jQuery) {
    return function (el, scrollCounter) {
      ...
      return top < pageYOffset + innerHeight + YOffset && left < pageXOffset + innerWidth + XOffset && top + height > pageYOffset && left + width > pageXOffset;
    };
  }(jquery);
  ...
  loader = function (jQuery, YottosLib, start, block_render, block_settings, move_shake, settings) {
    ...
    return Loader;
  }(jquery, ytl, start, block_render, block_settings, move_shake, settings);
  (function (Loader) {
